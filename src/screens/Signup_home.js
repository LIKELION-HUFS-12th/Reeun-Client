  ...
  return (
    <SafeAreaView>
      <Contents>
        ...
        <Text style={{fontSize:24, color:"#777777", lineHeight:33, fontWeight:200}}><Text style={{color:'#fb5e3d', fontWeight:700}}>회원가입{" "}</Text>하고,{"\n"}그리운 친구들과{"\n"}추억을 공유해보세요</Text>
      </Contents>
      <SignupStart>
        <View style={{justifyContent:'center', alignItems:'center', gap:20}}>
          <TouchableOpacity style={{backgroundColor:'#f5f5f5', width:250, height: 50, justifyContent:'center', borderRadius:10  }}>
            <View style={{flexDirection:'row',justifyContent:'center', alignItems:'center', gap:15}}>
              ...
              <Text style={{textAlign:'center', fontSize:16, fontWeight:500}}>아이디 입력 후 시작하기</Text>
            </View>
          </TouchableOpacity>
          <View style={{flexDirection:'row', gap:5}}>
            <Text style={{color:"#898989", fontSize:14}}>이미 회원이신가요?</Text>
            <TouchableOpacity>
              <Text style={{textDecorationLine:"underline", fontSize:15}}>로그인하기</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SignupStart>
